...
func registerSDKWords(r *eng.Registry, client *sdk.BranchCrossEventsExportSDK) {
...
func runOp(client *sdk.BranchCrossEventsExportSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
