...
type AnalyticsEntity struct {
	name    string
	client  *core.BranchCrossEventsExportSDK
...
func NewAnalyticsEntity(client *core.BranchCrossEventsExportSDK, entopts map[string]any) *AnalyticsEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnalyticsEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *AnalyticsEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AnalyticsCreateData and returns an Analytics. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AnalyticsEntity) CreateTyped(reqdata AnalyticsCreateData, ctrl map[string]any) (Analytics, error) {
