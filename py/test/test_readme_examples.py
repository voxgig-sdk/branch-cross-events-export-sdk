# BranchCrossEventsExport SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BranchCrossEventsExportSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BranchCrossEventsExportSDK(...) and BranchCrossEventsExportSDK.test(...) become
#      BranchCrossEventsExportSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "branchcrosseventsexport_sdk"
_SDK_CLASS = "BranchCrossEventsExportSDK"
