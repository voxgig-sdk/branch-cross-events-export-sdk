...
from branchcrosseventsexport_sdk.core import helpers

# Load utility registration (populates Utility._registrar)
from branchcrosseventsexport_sdk.utility import register

# Load features
from branchcrosseventsexport_sdk.feature.base_feature import BranchCrossEventsExportBaseFeature
from branchcrosseventsexport_sdk.features import _has_feature, _make_feature
...
class BranchCrossEventsExportSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BranchCrossEventsExportUtility()
        self._utility = utility

        from branchcrosseventsexport_sdk.config import shared_config
    ...
    def get_utility(self):
        return BranchCrossEventsExportUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BranchCrossEventsExportSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Analytics(self, data=None) -> "AnalyticsEntity":
        ...
        from branchcrosseventsexport_sdk.entity.analytics_entity import AnalyticsEntity
    ...
    def Status(self, data=None) -> "StatusEntity":
        ...
        from branchcrosseventsexport_sdk.entity.status_entity import StatusEntity
        return StatusEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BranchCrossEventsExportSDK":
        if sdkopts is None:
            sdkopts = {}
