...
from branchcrosseventsexport_sdk.core.control import BranchCrossEventsExportControl
...
from branchcrosseventsexport_sdk.core.helpers import get_ctx_prop, to_map
...
class BranchCrossEventsExportContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BranchCrossEventsExportControl()
        ...
        if isinstance(sp, BranchCrossEventsExportSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BranchCrossEventsExportResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BranchCrossEventsExportResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BranchCrossEventsExportOperation({})
        ...
        op = BranchCrossEventsExportOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return BranchCrossEventsExportError(code, msg, self)
