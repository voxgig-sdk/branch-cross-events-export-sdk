# BranchCrossEventsExport SDK feature corpus test
#
...
def _client(kase):
    ...
    BranchCrossEventsExportSDK(...), not BranchCrossEventsExportSDK.test(...): the `test` feature is
    ...
    return BranchCrossEventsExportSDK(opts)
