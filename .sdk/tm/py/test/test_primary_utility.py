...
from projectname_sdk import BranchCrossEventsExportSDK
from projectname_sdk.core.spec import BranchCrossEventsExportSpec
from projectname_sdk.core.result import BranchCrossEventsExportResult
from projectname_sdk.core.operation import BranchCrossEventsExportOperation
from projectname_sdk.core.error import BranchCrossEventsExportError
from projectname_sdk.feature.base_feature import BranchCrossEventsExportBaseFeature
...
_runner = makeRunner(TEST_JSON_FILE, BranchCrossEventsExportSDK.test(None, None))
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return BranchCrossEventsExportError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = BranchCrossEventsExportSDK.test(None, None)
        utility = client._utility
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = BranchCrossEventsExportResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = BranchCrossEventsExportSDK.test(None, None)
        ...
        class TestInitFeature(BranchCrossEventsExportBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BranchCrossEventsExportBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = BranchCrossEventsExportSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = BranchCrossEventsExportSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BranchCrossEventsExportSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BranchCrossEventsExportSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BranchCrossEventsExportSDK.test(None, setup.get('a') or {})
    ...
    def test_operator_basic(self):
        def subject(vin):
            if not isinstance(vin, dict):
                vin = {}
            op = BranchCrossEventsExportOperation(vin)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BranchCrossEventsExportSDK.test(None, setup.get('a') or {})
