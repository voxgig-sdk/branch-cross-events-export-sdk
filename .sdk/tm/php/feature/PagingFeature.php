...
// BranchCrossEventsExport SDK paging feature
...
class BranchCrossEventsExportPagingFeature extends BranchCrossEventsExportBaseFeature
{
    ...
    private function _graphql_pre_request(BranchCrossEventsExportContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BranchCrossEventsExportContext $ctx): bool
    {
