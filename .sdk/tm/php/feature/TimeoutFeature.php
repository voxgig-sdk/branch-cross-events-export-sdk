...
// BranchCrossEventsExport SDK timeout feature
...
class BranchCrossEventsExportTimeoutFeature extends BranchCrossEventsExportBaseFeature
{
    ...
    private function _with_timeout(BranchCrossEventsExportContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BranchCrossEventsExportContext $_ctx, float $ms): void
    {
        $client = $this->client;
