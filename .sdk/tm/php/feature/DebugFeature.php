...
class BranchCrossEventsExportDebugFeature extends BranchCrossEventsExportBaseFeature
{
    ...
    private function _finish(BranchCrossEventsExportContext $ctx, bool $ok): void
    {
