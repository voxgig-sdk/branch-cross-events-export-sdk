...
class BranchCrossEventsExportIdempotencyFeature extends BranchCrossEventsExportBaseFeature
{
    ...
    private function _mutating(BranchCrossEventsExportContext $ctx): bool
    {
