...
// BranchCrossEventsExport SDK utility: graphql
//
...
class BranchCrossEventsExportGraphql
{
    ...
    // equivalent.
    public static function body(BranchCrossEventsExportContext $ctx): mixed
    {
    ...
    public static function errors(BranchCrossEventsExportContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
