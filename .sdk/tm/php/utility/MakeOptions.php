...
// BranchCrossEventsExport SDK utility: make_options

class BranchCrossEventsExportMakeOptions
{
    ...
    public static function call(BranchCrossEventsExportContext $ctx): array
    {
        ...
        //
        // `BranchCrossEventsExportSchema::optspec()` is built from the model:
        ...
        $optspec = BranchCrossEventsExportSchema::optspec();
