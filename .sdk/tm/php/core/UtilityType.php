...
// BranchCrossEventsExport SDK utility type

class BranchCrossEventsExportUtility
{
    ...
    public static function copy(BranchCrossEventsExportUtility $src): BranchCrossEventsExportUtility
    {
        $u = new BranchCrossEventsExportUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
