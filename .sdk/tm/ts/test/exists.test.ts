...
describe('exists', async () => {
  ...
  //
  // BranchCrossEventsExportSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof BranchCrossEventsExportSDK, true,
      'BranchCrossEventsExportSDK.test() must return a client synchronously')
  })
