...
|---|---|---|
| `js/` | @voxgig-sdk/branch-cross-events-export-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/branch-cross-events-export | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/branch-cross-events-export-js \
      --repository voxgig-sdk/branch-cross-events-export-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/branch-cross-events-export-js` shows it, and
`npm trust revoke @voxgig-sdk/branch-cross-events-export-js --id=<id>` removes it.
