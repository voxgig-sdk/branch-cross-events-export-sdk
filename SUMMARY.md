...
Results: Job Successfully Finished.
...
| --- | --- | --- | --- |
| [Analytics](docs/api/analytics.html) | `create` | `POST /branch_aggregate/async/analytics` | See reference |
| [Status](docs/api/status.html) | `load` | `GET /branch_aggregate/async/status/{job_id}` | See reference |
...
- `branch-cross-events-export_list`: List records for an entity. No active entity supports this operation.
- `branch-cross-events-export_load`: Load one record for an entity. Supported entities: `status`.
