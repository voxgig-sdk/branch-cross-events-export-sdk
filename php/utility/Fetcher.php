...
// BranchCrossEventsExport SDK utility: fetcher

class BranchCrossEventsExportFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BranchCrossEventsExportSDK/1.0)';
    ...
    public static function call(BranchCrossEventsExportContext $ctx, string $fullurl, array $fetchdef): array
    {
