...
// BranchCrossEventsExport SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BranchCrossEventsExportSDK::test)
...
{
    private const SDK_CLASS = 'BranchCrossEventsExportSDK';
    ...
    private const SDK_BASE = 'branchcrosseventsexport_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../branchcrosseventsexport_sdk.php';
