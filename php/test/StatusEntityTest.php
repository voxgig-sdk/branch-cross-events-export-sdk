...
class StatusEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BRANCH_CROSS_EVENTS_EXPORT_TEST_STATUS_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function status_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BRANCH_CROSS_EVENTS_EXPORT_TEST_STATUS_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["BRANCH_CROSS_EVENTS_EXPORT_TEST_STATUS_ENTID"]);
