...
// BranchCrossEventsExport SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BranchCrossEventsExportOmni::makeStructRunner(
    ...
    {
        return BranchCrossEventsExportOmni::objmodel(BranchCrossEventsExportOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return BranchCrossEventsExportOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return BranchCrossEventsExportOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BranchCrossEventsExportOmni::structfix($now, Struct::undef()))
                        !== json_encode(BranchCrossEventsExportOmni::structfix($val, Struct::undef()))) {
