...
// BranchCrossEventsExport SDK pipeline test
//
...
require_once __DIR__ . '/../branchcrosseventsexport_sdk.php';
...
{
    private static function utility(): BranchCrossEventsExportUtility
    {
        return new BranchCrossEventsExportUtility();
    }
    ...
    private static function ctx(array $over = []): BranchCrossEventsExportContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BranchCrossEventsExportContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BranchCrossEventsExportOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BranchCrossEventsExportError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BranchCrossEventsExportOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BranchCrossEventsExportMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BranchCrossEventsExportOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BranchCrossEventsExportMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BranchCrossEventsExportOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BranchCrossEventsExportMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BranchCrossEventsExportSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BranchCrossEventsExportMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BranchCrossEventsExportResponse([]),
            'result' => new BranchCrossEventsExportResult([]),
        ]);
        [, $err] = BranchCrossEventsExportMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BranchCrossEventsExportSpec([]),
            'response' => null,
            'result' => new BranchCrossEventsExportResult([]),
        ]);
        [, $err] = BranchCrossEventsExportMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BranchCrossEventsExportSpec(['step' => 's']),
            'response' => new BranchCrossEventsExportResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BranchCrossEventsExportResult([]),
        ]);
        [, $err] = BranchCrossEventsExportMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BranchCrossEventsExportSpec(['step' => 's']),
            'response' => new BranchCrossEventsExportResponse(self::resp(200, ['v' => 1])),
            'result' => new BranchCrossEventsExportResult([]),
        ]);
        [, $err] = BranchCrossEventsExportMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BranchCrossEventsExportSpec(['step' => 's']),
            'response' => new BranchCrossEventsExportResponse(self::resp(200, ['v' => 2])),
            'result' => new BranchCrossEventsExportResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BranchCrossEventsExportMakeResponse::call($ctx);
    ...
    {
        $preset = new BranchCrossEventsExportResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BranchCrossEventsExportSpec([]),
            'response' => new BranchCrossEventsExportResponse([]),
            'result' => new BranchCrossEventsExportResult([]),
        ...
        [$got, $err] = BranchCrossEventsExportMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BranchCrossEventsExportResult([])]);
        [, $err] = BranchCrossEventsExportMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BranchCrossEventsExportSpec([]), 'result' => null]);
        [, $err] = BranchCrossEventsExportMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BranchCrossEventsExportSpec(['step' => 's']),
            'result' => new BranchCrossEventsExportResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BranchCrossEventsExportOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BranchCrossEventsExportMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BranchCrossEventsExportSpec(['step' => 's']),
            'result' => new BranchCrossEventsExportResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BranchCrossEventsExportOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BranchCrossEventsExportMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BranchCrossEventsExportResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BranchCrossEventsExportSpec([]),
            'result' => new BranchCrossEventsExportResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BranchCrossEventsExportMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BranchCrossEventsExportMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BranchCrossEventsExportError('boom', 'boom');
        $utility->fetcher = function (BranchCrossEventsExportContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BranchCrossEventsExportSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BranchCrossEventsExportMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BranchCrossEventsExportContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BranchCrossEventsExportMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BranchCrossEventsExportResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BranchCrossEventsExportMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BranchCrossEventsExportContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BranchCrossEventsExportSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BranchCrossEventsExportMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BranchCrossEventsExportResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BranchCrossEventsExportSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BranchCrossEventsExportMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BranchCrossEventsExportMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BranchCrossEventsExportMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BranchCrossEventsExportResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BranchCrossEventsExportDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BranchCrossEventsExportResult(['ok' => false])]);
        $this->expectException(BranchCrossEventsExportError::class);
        BranchCrossEventsExportDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BranchCrossEventsExportResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BranchCrossEventsExportMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BranchCrossEventsExportMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BranchCrossEventsExportBaseFeature();
        $b = new BranchCrossEventsExportBaseFeature();
        BranchCrossEventsExportFeatureAdd::call($ctx, $a);
        BranchCrossEventsExportFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BranchCrossEventsExportBaseFeature
    {
        $f = new BranchCrossEventsExportBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BranchCrossEventsExportFeatureAdd::call($ctx, self::named_feature('a'));
        BranchCrossEventsExportFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BranchCrossEventsExportFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BranchCrossEventsExportFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BranchCrossEventsExportFeatureAdd::call($ctx, $replace);
        ...
        BranchCrossEventsExportFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BranchCrossEventsExportContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BranchCrossEventsExportSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BranchCrossEventsExportPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BranchCrossEventsExportPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BranchCrossEventsExportResponse(['headers' => null]),
            'result' => new BranchCrossEventsExportResult([]),
        ]);
        BranchCrossEventsExportResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BranchCrossEventsExportResultBody::call($ctx);
