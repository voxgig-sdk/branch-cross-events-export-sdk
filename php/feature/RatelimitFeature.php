...
// BranchCrossEventsExport SDK ratelimit feature
...
class BranchCrossEventsExportRatelimitFeature extends BranchCrossEventsExportBaseFeature
{
    ...
    private function _acquire(BranchCrossEventsExportContext $ctx): void
    {
    ...
    private function _track(BranchCrossEventsExportContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
