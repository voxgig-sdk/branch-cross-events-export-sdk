...
class BranchCrossEventsExportMetricsFeature extends BranchCrossEventsExportBaseFeature
{
    ...
    private function _record(BranchCrossEventsExportContext $ctx, bool $ok): void
    {
