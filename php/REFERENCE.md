# BranchCrossEventsExport PHP SDK Reference

Complete API reference for the BranchCrossEventsExport PHP SDK.
...
#### `BranchCrossEventsExportSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): BranchCrossEventsExportUtility`
...
| `filter` | `array` | No | An object representing a filter, or multiple filters. |
...
| `limit_sort_spec` | `array` | No | An object describing column/row ordering and limiting. |
