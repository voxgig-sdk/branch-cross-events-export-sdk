...
(0, node_test_1.describe)('StatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BranchCrossEventsExportSDK({
    ...
    (0, node_test_1.test)('direct-load-status', async (t) => {
        ...
        const result = await client.direct({
            path: 'branch_aggregate/async/status/{id}',
            method: 'GET',
            params,
            query,
        });
...
function liveScenariosActive() { return false && process.env.BRANCH_CROSS_EVENTS_EXPORT_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BranchCrossEventsExportSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BRANCH_CROSS_EVENTS_EXPORT_TEST_STATUS_ENTID'];
    ...
    const client = new __1.BranchCrossEventsExportSDK({
        base: 'http://localhost:8080',
