...
function envOverride(m) {
    if ('TRUE' === process.env.BRANCH_CROSS_EVENTS_EXPORT_TEST_LIVE ||
        'TRUE' === process.env.BRANCH_CROSS_EVENTS_EXPORT_TEST_OVERRIDE) {
    ...
    m.BRANCH_CROSS_EVENTS_EXPORT_TEST_EXPLAIN = process.env.BRANCH_CROSS_EVENTS_EXPORT_TEST_EXPLAIN || m.BRANCH_CROSS_EVENTS_EXPORT_TEST_EXPLAIN;
    return m;
}
