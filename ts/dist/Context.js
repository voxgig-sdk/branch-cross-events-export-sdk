...
const BranchCrossEventsExportError_1 = require("./BranchCrossEventsExportError");
...
class Context {
    ...
    error(code, msg) {
        return new BranchCrossEventsExportError_1.BranchCrossEventsExportError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
