...
type Args struct {
	Entity string         `json:"entity" jsonschema:"analytics | status"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BranchCrossEventsExportSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-cross-events-export_list",
		Description: "List records from BranchCrossEventsExport. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-cross-events-export_load",
		Description: "Load a single record from BranchCrossEventsExport. " +
...
func runOp(client *sdk.BranchCrossEventsExportSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BranchCrossEventsExportSDK, name string) (sdk.BranchCrossEventsExportEntity, error) {
