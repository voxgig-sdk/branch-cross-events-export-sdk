...
function runner.env_override(m)
  local live = runner.getenv("BRANCH_CROSS_EVENTS_EXPORT_TEST_LIVE")
  local override = runner.getenv("BRANCH_CROSS_EVENTS_EXPORT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BRANCH_CROSS_EVENTS_EXPORT_TEST_EXPLAIN")
