...
local function make_error_util(ctx, err)
  ...
  local msg = "BranchCrossEventsExportSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = BranchCrossEventsExportError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == BranchCrossEventsExportError then
